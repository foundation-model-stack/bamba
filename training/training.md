...
```
To reproduce the exact model as Bamba-9B, you can find the training configs [here](https://github.com/foundation-model-stack/bamba/blob/main/training/data/README.md).
